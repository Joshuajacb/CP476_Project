<?php 
	...
	// Takes the user input text and uses that to create a new channel. 
	// Then checks the DB for that new channel and returns its channel ID so that the sidebar can be updated properly 


	require_once('config.php');
	session_start();

	$ch = $_POST['create_chname'];
	$ch = str_replace("'", "", $ch);
	$uid = $_SESSION['id'];
